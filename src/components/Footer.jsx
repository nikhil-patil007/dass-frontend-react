        ...
        <div className="ft-top">
          <div className="ft-intro">
            ...
            <div className="ft-gallery">
              ...
              <img src="/assets/images/about_banner_5.webp" alt="Celebration 1" />
              <img src="/assets/images/about_banner_3.jpeg" alt="Celebration 2" />
              <img src="/assets/images/about_banner_6.webp" alt="Celebration 3" />
            </div>
          </div>

          <div className="ft-cta">
            <h2 className="ft-heading right">
              than with jewellery<br /> crafted to last —<br /> The DASS
            </h2>

            <div className="ft-newsletter">
              <span className="ft-nl-label">Newsletter</span>
              <p className="ft-nl-copy">
                Join The DASS community for new drops, exclusive offers,
                and jewellery styling tips delivered to your inbox.
              </p>
